...
int main(int argc, char *argv[])
{
   ...
   e:	53                   	push   %ebx
   f:	51                   	push   %ecx
  10:	be fc 0a 00 00       	mov    $0xafc,%esi
  int i;
...
int main(int argc, char *argv[])
{
  ...
  int i;
  printf(1, "Thread exec test start\n");
  1a:	68 ed 07 00 00       	push   $0x7ed
  1f:	6a 01                	push   $0x1
  21:	e8 7a 04 00 00       	call   4a0 <printf>
...
int main(int argc, char *argv[])
{
  ...
  39:	e8 94 03 00 00       	call   3d2 <thread_create>
...
int main(int argc, char *argv[])
{
  ...
  4e:	e8 6f 03 00 00       	call   3c2 <sleep>
  printf(1, "This code shouldn't be executed!!\n");
  53:	58                   	pop    %eax
  54:	5a                   	pop    %edx
  55:	68 08 08 00 00       	push   $0x808
  5a:	6a 01                	push   $0x1
...
void *thread_main(void *arg)
{
  ...
  96:	e8 27 03 00 00       	call   3c2 <sleep>
  9b:	83 c4 10             	add    $0x10,%esp
  }
  
  printf(1, "This code shouldn't be executed!!\n");
  9e:	83 ec 08             	sub    $0x8,%esp
  a1:	68 08 08 00 00       	push   $0x808
  a6:	6a 01                	push   $0x1
...
void *thread_main(void *arg)
{
  ...
  b5:	6a 64                	push   $0x64
  b7:	e8 06 03 00 00       	call   3c2 <sleep>
    char *pname = "/hello_thread";
    char *args[2] = {pname, 0};
    printf(1, "Executing...\n");
  bc:	58                   	pop    %eax
  bd:	5a                   	pop    %edx
  be:	68 df 07 00 00       	push   $0x7df
  c3:	6a 01                	push   $0x1
  int val = (int)arg;
  printf(1, "Thread %d start\n", val);
  if (arg == 0) {
    ...
    char *pname = "/hello_thread";
    char *args[2] = {pname, 0};
  c5:	c7 45 f0 d1 07 00 00 	movl   $0x7d1,-0x10(%ebp)
  cc:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    printf(1, "Executing...\n");
  d3:	e8 c8 03 00 00       	call   4a0 <printf>
    exec(pname, args);
  d8:	59                   	pop    %ecx
  d9:	8d 45 f0             	lea    -0x10(%ebp),%eax
  dc:	5b                   	pop    %ebx
  dd:	50                   	push   %eax
  de:	68 d1 07 00 00       	push   $0x7d1
  e3:	e8 82 02 00 00       	call   36a <exec>
  e8:	83 c4 10             	add    $0x10,%esp
  eb:	eb b1                	jmp    9e <thread_main+0x2e>
  ed:	66 90                	xchg   %ax,%ax
  ef:	90                   	nop
...
putc(int fd, char c)
{
 ...
 5b8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5bb:	b8 2c 08 00 00       	mov    $0x82c,%eax
...
free(void *ap)
{
 ...
 641:	a1 f0 0a 00 00       	mov    0xaf0,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 697:	89 08                	mov    %ecx,(%eax)
  freep = p;
 699:	a3 f0 0a 00 00       	mov    %eax,0xaf0
}
 69e:	5b                   	pop    %ebx
 69f:	5e                   	pop    %esi
 6a0:	5f                   	pop    %edi
 ...
 6ba:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6bd:	a3 f0 0a 00 00       	mov    %eax,0xaf0
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 15 f0 0a 00 00    	mov    0xaf0,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 72f:	76 3f                	jbe    770 <malloc+0xa0>
    ...
    if(p == freep)
 731:	39 05 f0 0a 00 00    	cmp    %eax,0xaf0
 ...
 756:	e8 e5 fe ff ff       	call   640 <free>
  return freep;
 75b:	8b 15 f0 0a 00 00    	mov    0xaf0,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 77c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 77f:	89 15 f0 0a 00 00    	mov    %edx,0xaf0
      return (void*)(p + 1);
 ...
 794:	eb e9                	jmp    77f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 796:	c7 05 f0 0a 00 00 f4 	movl   $0xaf4,0xaf0
 79d:	0a 00 00 
 7a0:	c7 05 f4 0a 00 00 f4 	movl   $0xaf4,0xaf4
 7a7:	0a 00 00 
    base.s.size = 0;
 7aa:	b8 f4 0a 00 00       	mov    $0xaf4,%eax
 7af:	c7 05 f8 0a 00 00 00 	movl   $0x0,0xaf8
 7b6:	00 00 00 
